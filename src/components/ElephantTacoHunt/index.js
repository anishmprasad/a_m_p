...
rx = "17.2"
ry = "9.1"
fill = "#000" /> <ellipse cx = "78.5"
cy = "77.2"
rx = "24.4"
ry = "11.8"
fill = "#000" /> <ellipse cx = "55.6"
cy = "76.8"
rx = "19.3"
ry = "4.7"
fill = "#000" /> <ellipse cx = "31"
cy = "70.6"
rx = "15.5"
ry = "6.6"
fill = "#000" /> <ellipse cx = "23.2"
cy = "77.9"
rx = "23.2"
ry = "2.7"
fill = "#000" /> <ellipse cx = "52"
cy = "63.6"
rx = "21.5"
ry = "2.8"
fill = "#000" /> <ellipse cx = "194"
cy = "74.5"
rx = "16.7"
ry = "6.1"
fill = "#000" /> <ellipse cx = "168.9"
cy = "97.5"
rx = "36.5"
ry = "3.2"
fill = "#000" /> <ellipse cx = "166"
cy = "91.7"
rx = "32.4"
ry = "1.6"
fill = "#000" /> <ellipse cx = "131.2"
cy = "98.9"
rx = "21"
ry = "2.6"
fill = "#000" /> <path d = "M75.5 75.8c-12.2 0-23.1.5-30.1 1.2a48 48 0 0 0-5.5-.3 38.7 38.7 0 0 0-13.6 2.2h-1.6c-10.2 0-18.5.7-18.5 1.5s6.7 1.4 15.4 1.5a3.4 3.4 0 0 0-.8 2.1c-10.6.2-18.4.8-18.4 1.5s8.7 1.4 20.2 1.5c3 2.5 9.6 4.2 17.2 4.2a47.5 47.5 0 0 0 6.1-.4c.3 3.7 6 6.6 12.8 6.6s12.9-3.1 12.9-6.9-2.2-4.4-5.5-5.7A3.6 3.6 0 0 0 68 82v-.2h7.4c21.2 0 38.3-1.4 38.3-3s-17-3-38.2-3z"
fill = "#b5b1a8"
stroke = "#000"
stroke - miterlimit = "10"
stroke - width = ".5"
opacity = ".75" /> </svg>
  ...
  <svg class = "bk-clouds"
xmlns = "http://www.w3.org/2000/svg"
viewBox = "0 0 228.3 155.1" > <title> bk - clouds </title><path d="M183 44.5a57.9 57.9 0 0 0-26.3-6.1c-25.5 0-46.1 15.2-46.1 33.9a27.6 27.6 0 0 0 7 18l-5.3-.8a69.8 69.8 0 0 1-7.9-2 62.8 62.8 0 0 1-6.8-2.5C81.1 77.7 70 64.4 70 49.2c0-23 25.4-41.7 56.7-41.7 19 0 35.8 6.9 46.1 17.5a41.7 41.7 0 0 1 4.3 5.2 35.3 35.3 0 0 1 4 7.4 31.5 31.5 0 0 1 1.9 6.9z" fill="#000"/> <path d = "M189.5 43.9a35.2 35.2 0 0 0-4-7.2A46 46 0 0 0 172.9 25c-9.7-6.2-22.5-10-36.4-10C105.9 15 81 33.3 81 55.8c0 11.5 6.4 21.8 16.7 29.2a58.7 58.7 0 0 0 15.4 7.8 64.8 64.8 0 0 0 6.6 1.9l3.2.7a36.7 36.7 0 0 1-5.2-5 27.6 27.6 0 0 1-7-18c0-18.7 20.6-33.9 46.1-33.9a57.9 57.9 0 0 1 26.3 6.1 44.5 44.5 0 0 1 8.3 5.5 31.1 31.1 0 0 0-1.9-6.2z"
fill = "#b5b1a8" /> <path d = "M193.7 48.7a36.7 36.7 0 0 0-8.3-12 47.9 47.9 0 0 0-8.3-6.5c-9.3-5.8-21.3-9.3-34.4-9.3-29.5 0-53.4 17.6-53.4 39.3 0 10.6 5.8 20.3 15.1 27.4a52.4 52.4 0 0 0 8.6 5.3 61.4 61.4 0 0 0 10.9 4.1l1.6.4-2.7-2a36.7 36.7 0 0 1-5.2-5 27.6 27.6 0 0 1-7-18c0-18.7 20.6-33.9 46.1-33.9a57.9 57.9 0 0 1 26.3 6.1 44.5 44.5 0 0 1 8.3 5.5 36.5 36.5 0 0 1 4 3.9 30.2 30.2 0 0 0-1.6-5.3z"
fill = "#000" /> <path d = "M193.7 48.7a38.7 38.7 0 0 0-4.2-4.8 44.1 44.1 0 0 0-8.4-6.3 61.1 61.1 0 0 0-31-8c-27.4 0-49.5 16.3-49.5 36.5 0 9 4.4 17.2 11.7 23.5a45.6 45.6 0 0 0 7.3 5.2l4.3 2.2 2.7 1.2-1.1-.7-2.7-2a36.7 36.7 0 0 1-5.2-5 27.6 27.6 0 0 1-7-18c0-18.7 20.6-33.9 46.1-33.9a57.9 57.9 0 0 1 26.3 6.1 44.5 44.5 0 0 1 8.3 5.5 36.5 36.5 0 0 1 4 3.9 31.3 31.3 0 0 1 3.1 4.1 30.9 30.9 0 0 0-4.7-9.5z"
fill = "#b5b1a8" /> <path id = "cloudmove4"
d = "M95.6 71.5c0 2.6-3 4.7-6.7 4.7a8.3 8.3 0 0 1-5-1.6c-4.7 4.3-11.9 7.1-20.1 7.1-13.9 0-25.1-8-25.1-17.9v-.5H38c-16.4 0-20.7-12-20.7-26.8 0-8.4-4.8-15.8 1.9-20.7-1.6-1.6.3-2.5.3-4.6C19.4 5.6 23.5 0 32.1 0c5.5 0 10.3 1.9 13.1 4.7 5.9.1 10.4.7 10.4 1.4S52 7.3 47 7.4a6.9 6.9 0 0 1 .6 2.8 6.4 6.4 0 0 1-.1 1 30.6 30.6 0 0 1 6.7 2.9 22.4 22.4 0 0 1 24.3 31.5h1.1a7.2 7.2 0 0 1 5.6 8.5v.3a14.2 14.2 0 0 1 3.7 9.3 13.1 13.1 0 0 1-.4 3h.4c3.7.2 6.7 2.2 6.7 4.8z"
fill = "#000" /> <path id = "cloudmove2"
d = "M179.7 84.9c1 4.1-3.9 8.8-11 10.5l-3.4.6c-1.9 4.1-10.7 9-21.9 11.8-9.5 2.4-18.1 2.6-22.7 1a11.6 11.6 0 0 1-6.7 4.7c-4.9 1.2-9.9-1-13-5.1a19.6 19.6 0 0 1-10.4 6.6c-9.3 2.3-18.8-2.5-23.3-11.2a19 19 0 0 1-10.5 7c-11.7 2.9-24-6.2-27.5-20.3-2.7-10.7.5-21.2 7.3-26.9l.8-.3-.2-.2-.6.5-1.2.4a12.3 12.3 0 1 1 6.3-19.9l1.3-.4a11.7 11.7 0 0 1 13.8 7.1 17.1 17.1 0 0 1 5.3-2.3A17.4 17.4 0 0 1 83.2 61a16.9 16.9 0 0 1 .5 4 14.6 14.6 0 0 1 22.5 8.5 14.7 14.7 0 0 1 .4 3.4l1.2-.4c5.1-1.3 10 .6 10.9 4.2a5.8 5.8 0 0 1-1.4 5.1h-.4a4.3 4.3 0 0 0-1.7.8l.7.4 1.3-1.3a4.4 4.4 0 0 1 4.9 3.3 4.2 4.2 0 0 1 .1.7 84.1 84.1 0 0 1 10.8-3.4l5.5-1.2c0-4.1 4.1-8.3 9.9-9.8s12.7.8 13.8 5.4v.6l2.6-.8c7.3-1.6 13.9.3 14.9 4.4z"
fill = "#b5b1a8"
stroke = "#000"
stroke - miterlimit = "10" /> <path d = "M202.3 109.8l-.6-.8c2.1-.7 3.5-1.6 3.5-2.6s-3.7-3.2-8.5-3.5a2.4 2.4 0 0 0 0-3.3h1.5c6.9 0 12.5-.9 12.5-2.1s-5.6-2.1-12.5-2.1h-1.7a7 7 0 0 0 .8-3.4c-.1-4.8-5.1-8.6-11.3-8.5s-11.1 4-11.1 8.8v.2l-1.2.7a5.8 5.8 0 0 0-4.3-1.7l-1.6.2c-2.3-5.8-10.8-10-20.8-9.8-6.3.1-11.9 1.9-15.8 4.7-.6-1.5-2.6-2.6-5-2.7a7.8 7.8 0 0 0 .2-1.6c-.1-5-4.9-9.1-10.9-9a10.9 10.9 0 0 0-9.8 5.4h-.9c-7.1.1-13.1 2.6-15.6 6a18.8 18.8 0 0 0-4.4-.5c-6.7.1-12.1 3.5-12 7.7a5.5 5.5 0 0 0 1.7 3.8h-4l.3 17.7 111.4-1.6c1.2 1.8 5.2 3.2 10 3.2s8.7-1.3 9.9-3.1c4.9-.1 8.6-.5 8.6-1.1s-3.5-.9-8.4-1z"
fill = "#000" /> <path d = "M77.3 71.5h-.8a12 12 0 0 0 .8-4.2c0-8-7.9-14.4-17.6-14.4s-17.5 6.5-17.5 14.4 7.9 14.4 17.6 14.4l3.1-.2a9.8 9.8 0 0 0-.2 1.9c0 6.6 6.6 11.9 14.7 11.9S92.1 90 92.1 83.4s-6.6-11.9-14.8-11.9z"
fill = "#000" /> <path id = "cloudmove1"
d = "M138.2 99.2c0 4.2-5.9 7.6-13.2 7.6l-3.5-.3c-2.8 3.5-12.5 6.1-24.1 6.1-9.7 0-18.2-1.9-22.3-4.6a11.6 11.6 0 0 1-7.7 3c-5 0-9.3-3.3-11.3-8.1a19.6 19.6 0 0 1-11.6 3.8c-9.6 0-22.1 18.2-24.3 8.7-3.4 2.7-3-20.9-7.4-20.9-12 0 1.5-12.2 1.5-26.7 0-11-8.7-20.1-.7-24h.8v-.2l-.7.3Q4.2 44.8.1 31.7l12.2-12.3a12.3 12.3 0 0 1 11 6.8h1.3c6 0 6.5 3.5 7.3 9.2 1.8-.6-.9 0 1.1 0a17.4 17.4 0 0 1 17.4 17.3 16.9 16.9 0 0 1-.5 4 14.6 14.6 0 0 1 19.7 13.7 14.7 14.7 0 0 1-.4 3.4h1.2c5.3 0 9.6 3 9.6 6.7a5.8 5.8 0 0 1-2.6 4.6H77a4.3 4.3 0 0 0-1.8.4l.6.6 1.6-1a4.4 4.4 0 0 1 4 4.4 4.2 4.2 0 0 1-.1.7 84.1 84.1 0 0 1 11.3-.7l5.6.2c1-4 6-7.1 11.9-7.1s12.3 3.8 12.3 8.5v.6l2.7-.2c7.2.1 13.1 3.5 13.1 7.7z"
fill = "#b5b1a8" /> <path d = "M22 118.1h-.8l.7-.3z"
fill = "#9b9a9a" /> <path d = "M22 118.1h-.8l.7-.3z"
fill = "#9b9a9a" /> <ellipse cx = "153.9"
cy = "49.9"
rx = "21.5"
ry = "3.2"
fill = "#000" /> <ellipse cx = "199.9"
cy = "31.3"
rx = "12.5"
ry = "1.8"
fill = "#000" /> <ellipse cx = "146.3"
cy = "45.1"
rx = "8.4"
ry = "4.7"
fill = "#000" /> <ellipse cx = "208.7"
cy = "45.2"
rx = "17.4"
ry = "7.8"
fill = "#000" /> <ellipse cx = "150.3"
cy = "37.9"
rx = "8.4"
ry = "6.6"
fill = "#000" /> <path id = "cloudmove3"
d = "M216.4 49.4h-.8c-.6-2.5-4.2-4.3-8.5-4.3a14.1 14.1 0 0 0-3.1.3 19.7 19.7 0 0 0-11.8-9.6 8.4 8.4 0 0 0-6.6-12.7v-.6a8.1 8.1 0 1 0-8.9 8 8.4 8.4 0 0 0-.1.9 8.3 8.3 0 0 0 1.3 4.5 21.8 21.8 0 0 0-4.1 1.8l-.8-1a2.8 2.8 0 0 0 2-2.5c0-1.6-1.6-2.8-3.5-2.8a3.4 3.4 0 0 0-3.4 2.2 17.7 17.7 0 0 0-5.8-1c-7.1 0-12.8 3.9-12.8 8.7a6.3 6.3 0 0 0 1 3.4c-5.7.2-9.9.8-9.9 1.6s6 1.6 13.3 1.6a16.6 16.6 0 0 0 8.3 2.1l2.7-.2a15.6 15.6 0 0 0-.2 2.7c0 9.8 9.2 17.8 20.5 17.8S204 63.6 205.5 55h1.6a11.4 11.4 0 0 0 6.9-2h2.4c6.4 0 11.7-.8 11.7-1.9s-5.3-1.7-11.7-1.7z"
fill = "#b5b1a8"
stroke = "#000"
stroke - miterlimit = "10"
...
fill = "#000" / > </svg>
  ...
  const Elephant = React.createClass({
    render() {
      return ( <svg className = "elephant"
        xmlns = "http://www.w3.org/2000/svg"
        viewBox = "15 15 255 130" >
        <path id = "ear-right"
        className = "st0"
        d = "M173.9 62s58.7-16.7 68.3-32.3c9.7-15.7 19.7-11 18-2.7-1.7 8.3-40 49.3-49.7 47.7-9.7-1.7-27.7 7.1-31 0-3.2-7-15.7-9-5.6-12.7z" / >
        <path className = "st1"
        d = "M154.1 117.3s16.5 6.9 18.5 11.2c2 4.2 1.5 6 3.5 5.8s11.2-5.8 8-12.9-23-24.9-28.8-17.4-6.2 12.4-1.2 13.3z" / >
        <ellipse className = "st0"
        cx = "130.8"
        cy = "88.7"
        rx = "35.2"
        ry = "28.7" / >
        <ellipse className = "st2"
        cx = "87.4"
        cy = "92.8"
        rx = "10.8"
        ry = "4.2" / >
        <path className = "st1"
        d = "M208.3 104.6c0 .3-.1.5-.4.6l-16.1 2.8c-.3 0-.5-.1-.6-.4l-2.3-12.3c0-.3.1-.5.5-.6l16-3.8h.1c.1 0 .2.1.3.1.1 0 .2.1.2.3l2.3 13.3z" / >
        <path className = "st1"
        d = "M245.4 85.4c-.3-1.3-.8-2.5-1.7-3.6-2.7-3.3-7.4-3.9-10.3-1.5-3 2.5-3.2 7.1-.5 10.4 2.2 2.6 5.6 3.6 8.4 2.6v.3c1 13-14.1 6.7-14.1 6.7-.2-.6-.4-1.2-.6-1.7l-2.2.7c-.5-.6-1.1-1.1-1.9-1.5l3.1-1c-.9-1.2-2.2-2.2-4.1-3.2.1-.8.1-2.7.1-3.5v-.8l-5.3.4c-.2 0-.5.2-.6.4-.2.2-.2.5-.2.8l1.1 6.4c-.7.2-1.3.5-1.9.9l-.7-3.8-4.3 1.2 1.5 8.4c.3 1.9-.9 3.7-2.8 4l-16.1 2.8h-.6c-1.7 0-3.2-1.2-3.5-2.9l-2.3-12.3c-.3-1.9.9-3.7 2.8-4.1l16-3.8c1-.2 1.9 0 2.7.6.8.5 1.3 1.3 1.4 2.3l.5 3 4.3-1.2-.2-1.2c-.1-.8 0-1.6.5-2.2.5-.7 1.2-1.1 1.9-1.2h.1l5.4-.4c-.5-5.2-2.5-10-5.6-14.2-2.9-3.9-6.8-7.2-11.3-9.8-5.5-3-11.9-4.9-18.8-5.1H184c-10.8 0-20.5 3.8-27.3 10-.2.2-.4.3-.5.5-5.2 4.9-8.6 11.1-9.4 17.9-.1 1.1-.2 2.2-.2 3.3-1.3 2.2-1.7 4.7-1.5 7.5.2 2.1.8 4.4 1.8 6.6 1 2.3 2.5 4.5 4.4 6.6.2.3.5.5.7.8.7.8 1.6 1.5 2.4 2.3l.3.3c4 3.3 8.5 5.2 12.7 5.9 4.6 2.4 10.6 4.2 17.4 4.9.7.1 1.4.1 2.2.2 10 .7 19-1.2 24.7-4.6 1.9-.5 3.8-1.3 5.5-2.1 1.2-.6 2.4-1.3 3.4-2 8.2 3.5 17.8 3.1 17.8 3.1 21.3-.2 13-24.1 7-34.1z" / >
        <path className = "st2"
        d = "M120.9 116.5s-20.3-44.5-7.5-52.8c0 0-65.1 26.3 7.5 52.8z" / >
        <ellipse className = "st2"
        cx = "87.8"
        cy = "99.8"
        rx = "19.2"
        ry = "7.8" / >
        <path className = "st2"
        d = "M204.8 63.6s-20.1-29.6-44-11.9c0 0-3.9-3.3-7.3 3.3-4 7.9-5.1 7.3-5.1 7.3s-6-4.2-6.9 10.5c-.8 14.7-15.7 22.5-4.8 26.2 10.8 3.7 31.8-23.7 31.8-23.7s19.7-16.8 36.3-11.7z" / >
        <path id = "ear-left"
        className = "st0"
        d = "M160.3 68.7S111.6 63 64 78.4c0 0-31.3 5.7-35 0 0 0-18.7-5.3-5.7 5.2 0 0 20.3 15.8 55.3 16s60.7-11.2 60.7-11.2l23.7-4.8c-.1-.1 23.3-13.9-2.7-14.9z" / >
        <g id = "eyes" >
        <ellipse className = "st3"
        cx = "200.7"
        cy = "99.5"
        rx = "2.2"
        ry = "4.5" / >
  ...
  const Opener = React.createClass({
    ...
    render() {
      return ( <div className = "openContainer" >
        <div className = "overlay overlayOpener" >
        </div> 
        <div className = "opener" >
        <div id = "opener-text" >
        Once there was an elephant.He was excited to go out with his friends and get tacos, but they kept texting him to change the plans.Help the elephant get all the tacos and avoid flakey text messages to get to delicious glory!
        </div> 
        <button className = "start"
        onClick = {
