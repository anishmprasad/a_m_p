...
var data = [
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/certificate-transparency/logo.png?rs=AGWjSYS71O6krdCVrIkQFrjZcyQLwJaLOQ&sqp=-oaymwEKCIwBEIwBIABQAQjcz4zKBQ',
		primaryColor: '#181C1D',
		startsWith: 'c',
		fallbackColor: '#4285F4',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/go/logo.png?rs=AGWjSYQIri4x-kAIlXKHB1dV2JvRjfAMaw&sqp=-oaymwEICEwQTCAAUAEIyaPvzwU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/go/logo.png?rs=AGWjSYSM2HrXhFKt45UThyUQcH12FiHb4A&sqp=-oaymwEKCIwBEIwBIABQAQjJo-_PBQ',
		primaryColor: '#6FD6E2',
		startsWith: 'g',
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/boringssl/logo.png?rs=AGWjSYSEPrTRB72-vV8kLoK6OvdxwtWKvQ&sqp=-oaymwEKCIwBEIwBIABQAQjFz4zKBQ',
		primaryColor: '#6B4B9F',
		startsWith: 'b',
		fallbackColor: '#4285F4',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/dart/logo.png?rs=AGWjSYTwt-Si12dEHIA4D5KpYxR3pwK82g&sqp=-oaymwEKCIwBEIwBIABQAQjoz4zKBQ',
		primaryColor: '#13D5BD',
		startsWith: 'd',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/blockly/logo.png?rs=AGWjSYRV0sNg8IhMgM5ugZ2Nj9SaHIL66Q&sqp=-oaymwEKCIwBEIwBIABQAQjAwJTeBQ',
		primaryColor: '#81A8E6',
		startsWith: 'b',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/agera/logo.png?rs=AGWjSYQPQyGM5oGxGN3oBBrThh3LjpLT4A&sqp=-oaymwEICEwQTCAAUAEI3M2MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/agera/logo.png?rs=AGWjSYRhzI3zIsn6nt3xUBGtum6_ko91og&sqp=-oaymwEKCIwBEIwBIABQAQjczYzKBQ',
		primaryColor: '#b3278a',
		startsWith: 'a',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/polymer/logo.png?rs=AGWjSYQXJyxg-xk4g0c4vsKM29S6uyXRYw&sqp=-oaymwEKCIwBEIwBIABQAQim0IzKBQ',
		primaryColor: '#337FCC',
		startsWith: 'p',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/android/logo.png?rs=AGWjSYRXr3HTiuFOt8WbU11Z6Z5N5LaGHA&sqp=-oaymwEICEwQTCAAUAEIls6MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/android/logo.png?rs=AGWjSYQm0KiD6oVf3pyh_OVY14Jlw0BLrw&sqp=-oaymwEKCIwBEIwBIABQAQiWzozKBQ',
		primaryColor: '#A7C640',
		startsWith: 'a',
		fallbackColor: '#EA4335',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/hilbert/logo.png?rs=AGWjSYQTqu_WI9fJNCPEfK1BCBICs6TMgw&sqp=-oaymwEKCIwBEIwBIABQAQiF0IzKBQ',
		primaryColor: '#323232',
		startsWith: 'h',
		fallbackColor: '#EA4335',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/magenta/logo.png?rs=AGWjSYS_R9U5smHKuwxxuan1_I5Fw4Htqg&sqp=-oaymwEICEwQTCAAUAEIq-ep0wU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/magenta/logo.png?rs=AGWjSYQlWMmya8kAkF-qoTFOZzQjdH0GBA&sqp=-oaymwEKCIwBEIwBIABQAQir56nTBQ',
		primaryColor: '#06213C',
		startsWith: 'm',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		summary:
			'A collection of components to collect data and train a user model and a corresponding search engine result page evaluation metric',
		startsWith: 'c',
		fallbackColor: '#34A853',
		RGB: {
			r: 52,
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/end-to-end/logo.png?rs=AGWjSYS32piV518oS_phcX2uRW8HgXSxdg&sqp=-oaymwEICEwQTCAAUAEI7M-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/end-to-end/logo.png?rs=AGWjSYQ9eAxVcxhiHocbr1EcP5nTDGduGA&sqp=-oaymwEKCIwBEIwBIABQAQjsz4zKBQ',
		primaryColor: '#333332',
		startsWith: 'e',
		fallbackColor: '#EA4335',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/radioreceiver/logo.png?rs=AGWjSYR5aGEUDKkGoJTfE9Tqs9m4-iqA5g&sqp=-oaymwEICEwQTCAAUAEIrNCMygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/radioreceiver/logo.png?rs=AGWjSYTiwctcKz_hTEJjKsKGc4V9wvg4uA&sqp=-oaymwEKCIwBEIwBIABQAQis0IzKBQ',
		primaryColor: '#AA7522',
		startsWith: 'r',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/copybara/logo.png?rs=AGWjSYRcqYtpQLzsmUpelNOd4jWPafqXyQ&sqp=-oaymwEICEwQTCAAUAEI58-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/copybara/logo.png?rs=AGWjSYQxeK8CMbsyVMQwoMvbr55ShrUBVA&sqp=-oaymwEKCIwBEIwBIABQAQjnz4zKBQ',
		primaryColor: '#41929D',
		startsWith: 'c',
		fallbackColor: '#EA4335',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/nomulus/logo.png?rs=AGWjSYSvdDD51Hnwtd2UelbayJHC3BNqoQ&sqp=-oaymwEKCIwBEIwBIABQAQiW0IzKBQ',
		primaryColor: '#394A4A',
		startsWith: 'n',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/airport/logo.png?rs=AGWjSYQEhNrDqJwQcitPNDUV_eHGJXJTyQ&sqp=-oaymwEICEwQTCAAUAEI3c2MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/airport/logo.png?rs=AGWjSYQMTJ6LKWb9BNQMCm3AQdFSXuuJUw&sqp=-oaymwEKCIwBEIwBIABQAQjdzYzKBQ',
		primaryColor: '#DDCEC5',
		startsWith: 'a',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/touchtime/logo.png?rs=AGWjSYS1M1jVtEIIwr5iFRx6zZnUOTj23Q&sqp=-oaymwEKCIwBEIwBIABQAQi30IzKBQ',
		primaryColor: '#DC4538',
		startsWith: 't',
		fallbackColor: '#4285F4',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/remixer/logo.png?rs=AGWjSYTBgQzeXCmgJGtj60Avuohi-ajM1Q&sqp=-oaymwEICEwQTCAAUAEIrdCMygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/remixer/logo.png?rs=AGWjSYRgBL6sza4Vx_DlL60KU3whDoqVAQ&sqp=-oaymwEKCIwBEIwBIABQAQit0IzKBQ',
		primaryColor: '#E783FB',
		startsWith: 'r',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/chromium/logo.png?rs=AGWjSYSS9emrk8fsE8ilistYp-hehxe9aw&sqp=-oaymwEICEwQTCAAUAEI3s-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/chromium/logo.png?rs=AGWjSYRKTmOG5h_4JAV3RX7qC43SlcASqw&sqp=-oaymwEKCIwBEIwBIABQAQjez4zKBQ',
		primaryColor: '#83AEF6',
		startsWith: 'c',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/grpc/logo.png?rs=AGWjSYRrOGw1DlS5z6vkQzr0OghB3IRMZA&sqp=-oaymwEICEwQTCAAUAEItomr2QU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/grpc/logo.png?rs=AGWjSYQ3FewM1B7a0VvhcYBMv0tHuoWX5A&sqp=-oaymwEKCIwBEIwBIABQAQi2iavZBQ',
		primaryColor: '#44AFB8',
		startsWith: 'g',
		fallbackColor: '#EA4335',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/ganeti/logo.png?rs=AGWjSYSpPU48geCulsW-AB8lYJEXFo3seQ&sqp=-oaymwEICEwQTCAAUAEI9c-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/ganeti/logo.png?rs=AGWjSYSN06hxhOdtlYL9QrMPpWUZMR-fow&sqp=-oaymwEKCIwBEIwBIABQAQj1z4zKBQ',
		primaryColor: '#B5D1FA',
		startsWith: 'g',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/flutter/logo.png?rs=AGWjSYQ1k3HIfNH4B0MlpAiv3cxy8XqcwA&sqp=-oaymwEKCIwBEIwBIABQAQjzz4zKBQ',
		primaryColor: '#4CC2F7',
		startsWith: 'f',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/badwolf/logo.png?rs=AGWjSYTR41y0H8G1uqqNm8aQR7q9Anbmtg&sqp=-oaymwEICEwQTCAAUAEIn8-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/badwolf/logo.png?rs=AGWjSYQCjlnMytINQtPzuoGgmWcb3ZKOcg&sqp=-oaymwEKCIwBEIwBIABQAQifz4zKBQ',
		primaryColor: '#1E4689',
		startsWith: 'b',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/upspin/logo.png?rs=AGWjSYR6o4JRgj6bXCudS8qCAMymYZcoNQ&sqp=-oaymwEICEwQTCAAUAEIvNCMygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/upspin/logo.png?rs=AGWjSYR8NogatQRGnAbDHYtrOKBzDgPgpA&sqp=-oaymwEKCIwBEIwBIABQAQi80IzKBQ',
		primaryColor: '#fffce6',
		startsWith: 'u',
		fallbackColor: '#EA4335',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/oppia/logo.png?rs=AGWjSYRdfOh2ereKA7kjMm48M7wRec2sNw&sqp=-oaymwEKCIwBEIwBIABQAQiY0IzKBQ',
		primaryColor: '#16AA9D',
		startsWith: 'o',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/material-components-ios/logo.png?rs=AGWjSYRJufihcla3pM8JFDPNR-JL-eRkog&sqp=-oaymwEKCIwBEIwBIABQAQiT0IzKBQ',
		primaryColor: '#00e676',
		startsWith: 'm',
		fallbackColor: '#4285F4',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/cloudprint_logocert/logo.png?rs=AGWjSYSYcMcq8T1DOyWeNtdF2EasfSxY0g&sqp=-oaymwEICEwQTCAAUAEI5s-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/cloudprint_logocert/logo.png?rs=AGWjSYRjdtGyPHf2t8EkQZjnuWoko-36oA&sqp=-oaymwEKCIwBEIwBIABQAQjmz4zKBQ',
		primaryColor: '#577EBF',
		startsWith: 'g',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/science-journal/logo.png?rs=AGWjSYSvqBlcaqZJUWpcSRRyscZCuKITqg&sqp=-oaymwEICEwQTCAAUAEIkKOm1QU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/science-journal/logo.png?rs=AGWjSYTGzmaGSvElBxnAweou7HNTPKTqGw&sqp=-oaymwEKCIwBEIwBIABQAQiQo6bVBQ',
		primaryColor: '#3C7CE9',
		startsWith: 'o',
		fallbackColor: '#4285F4',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/tensorflow/logo.png?rs=AGWjSYQ1HC13sEyluXwZoYWC2w2i9qsPjQ&sqp=-oaymwEICEwQTCAAUAEIttCMygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/tensorflow/logo.png?rs=AGWjSYQ7IXg35u8B_D41kSCIRrHjJYcfng&sqp=-oaymwEKCIwBEIwBIABQAQi20IzKBQ',
		primaryColor: '#E26026',
		startsWith: 't',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/ezgantt/logo.png?rs=AGWjSYRUHGn6VJ9z6_bES0EJwbfnkDxX-w&sqp=-oaymwEICEwQTCAAUAEI7s-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/ezgantt/logo.png?rs=AGWjSYTR0v_Sr9w-KDtd7gaUfwLAtgrz1w&sqp=-oaymwEKCIwBEIwBIABQAQjuz4zKBQ',
		primaryColor: '#A59B94',
		startsWith: 'e',
		fallbackColor: '#FBBC05',
		RGB: {
	...
	},
	{
		...
		iconUrlSmall:
			'https://www.gstatic.com/opensource/project-images/dart-sass/logo.png?rs=AGWjSYT3AeO8-KcAJEcaxh_HZ_V-F8J7Ug&sqp=-oaymwEICEwQTCAAUAEI6M-MygU',
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/dart-sass/logo.png?rs=AGWjSYQg4x3vqdZiEWGVDEwSi1KkM9Veiw&sqp=-oaymwEKCIwBEIwBIABQAQjoz4zKBQ',
		primaryColor: '#C76395',
		startsWith: 'd',
		fallbackColor: '#34A853',
		RGB: {
	...
	},
	{
		...
		iconUrlMedium:
			'https://www.gstatic.com/opensource/project-images/permission.site/logo.png?rs=AGWjSYRT5_8kyuLvW5Qomjbu1kPPz8gmSg&sqp=-oaymwEKCIwBEIwBIABQAQif0IzKBQ',
		primaryColor: '#545454',
		startsWith: 'p',
		fallbackColor: '#4285F4',
		RGB: {
