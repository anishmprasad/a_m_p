...
// import PropTypes from 'prop-types';
// import 'styleCommon/ConceptKT.scss';
// import Graph from 'vis-react';
// // import vis from 'vis';

// import { segmentTrack, getObjects } from 'constants/global_common_functions';
...
// class ConceptKT extends React.Component {
// 	setState(stateObj) {
// 		if (this.mounted) {
...
// 			}
// 		};
// 		let jsonData = this.props.initialGraph;
...
// 				<div className='ConceptKTContainer'>
// 					{this.props.title && (
// 						<div className='heading'>
// 							{this.props.title}
// 							{this.props.description && <p className='kt-text'>{this.props.description}</p>}
// 						</div>
// 					)}
// 					<Graph
